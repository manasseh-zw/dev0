      ...
      <div className="px-3 py-2.5">
        <div className="flex items-center gap-2 mb-2">
          ...
          {task.priority === "urgent" && !isCompleted && (
            <HugeiconsIcon icon={StarIcon} className="size-4 shrink-0 text-pink-500" />
          )}
          {task.priority === "high" && !isCompleted && (
            <HugeiconsIcon icon={InformationCircleIcon} className="size-4 shrink-0 text-red-500" />
          )}
          {task.priority === "medium" && !isCompleted && (
            <HugeiconsIcon icon={HexagonIcon} className="size-4 shrink-0 text-cyan-500" />
          )}
          {isCompleted && (
            <HugeiconsIcon icon={CheckmarkCircle02Icon} className="size-4 shrink-0 text-green-500" />
          )}
        </div>
